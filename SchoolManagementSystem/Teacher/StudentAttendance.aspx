        ...
        <div class="container p-md-4 p-sm-4">
            ...
            <div class="row mb-3 mr-lg-5 ml-lg-5 mt-md-5">
                <div class="col-md-3 col-md-offset-2 mb-3">
                    <asp:Button ID="btnSubmit" runat="server" CssClass="btn-primary btn-block; form-control" BackColor="#5558C9" Text="Submit" OnClick="btnSubmit_Click" />
                </div>
            </div>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Class">
                                <ItemTemplate>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <asp:RadioButton ID="RadioButton2" runat="server" CssClass="form-check-input" Text="Absent" GroupName="attendance" />
                                    </div>
                                </ItemTemplate>
            ...
            <div class="row mb-3 mr-lg-5 ml-lg-5 mt-md-5">
                <div class="col-md-6 col-lg-4 col-xl-3 col-md-offset-2 mb-3">
                    <asp:Button ID="btnMarkAttendance" runat="server" CssClass="btn-primary btn-block; form-control" BackColor="#5558C9" 
                        Text="Marks Attendance" OnClick="btnMarkAttendance_Click"  />
                </div>
            </div>
