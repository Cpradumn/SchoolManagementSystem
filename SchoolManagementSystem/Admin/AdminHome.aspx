...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="background-image: url('../Image/adminhomepageimg1.jpg'); width: 100%; height: 100px; background-repeat: no-repeat; background-size: cover; background-attachment: fixed;">
            ...
            <div class="row pt-5">
                <div class="col-md-3">
                    <div class="card-counter primary">
                        <i class="fa fa-code-users"></i>
                        <span class="count-numbers"><%Response.Write(Session["Student"]); %></span>
                        <span class="count-name">Toatl Students</span>
                    </div>
                </div>
