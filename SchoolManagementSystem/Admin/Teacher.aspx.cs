...
namespace SchoolManagementSystem.Admin
{
    public partial class Teacher : System.Web.UI.Page
    {
        ...
        {
            DataTable dt = fn.Fetch(@"Select ROW_NUMBER() OVER(ORDER BY (SELECT 1)) as [Sr.No], TeacherId, [Name],DOB, 
                                    Gender, Mobile, Email, [Address], [password] from Teacher");
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                if(ddlGender.SelectedValue != "0")
                {
                    ...
                    if(dt.Rows.Count == 0)
                    {
                        string query = "Insert into Teacher values('" + txtName.Text.Trim() + "','" + txtDoB.Text.Trim() + "','" + ddlGender.SelectedValue + "'," +
                            "'" + txtMobile.Text.Trim() + "','" + txtEmail.Text.Trim() + "','" + txtAddress.Text.Trim() + "','" + txtPassword.Text.Trim() + "')";
                        fn.Query(query);
                    ...
                    {
                        lblmsg.Text = "Entered for<b>'" + email + "'</b> Already exists!";
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                lblmsg.Text = "Teacher Deleted Sucessfully";
